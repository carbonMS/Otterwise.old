// Crie um algoritmo que tem como entrada um objeto e imprime no console os nomes dos projetos ativos
// do usuário.
...
for (let index = 0; index < user.projects.length; index++) {
  if (user.projects[index].active) console.log(user.projects[index].name);
}
